    ...
    void OnEnable()
    {
        ...
        if (playerInput != null)
        {
            if (playerType == PlayerType.RedPlayer)
            {
                ...
                playerInput.RedPlayerMovement.MoveUp.performed += (context) => playerController.MoveUp(context.ReadValue<float>());
            ...
            else if (playerType == PlayerType.BluePlayer)
            {
                ...
                playerInput.BluePlayerMovement.MoveUp.performed += (context) => playerController.MoveUp(context.ReadValue<float>());
